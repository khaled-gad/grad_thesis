...
\begin{table}[H]
\centering
\caption{Peak speedup across all evaluated configurations for each RaiVeX Library kernel.}
...
\toprule
\textbf{Input} & \textbf{Output} & \textbf{Best} & \textbf{Scalar} & \textbf{Best} & \textbf{Speedup} \\
\textbf{Size} & \textbf{Size} & \textbf{Implementation} & \textbf{Cycles} & \textbf{Cycles} & \\
\midrule
...
\toprule
\textbf{Input} & \textbf{Filters} & \textbf{Kernel} & \textbf{Best} & \textbf{Scalar} & \textbf{Best} & \textbf{Speedup} \\
\textbf{Shape} & & & \textbf{Implementation} & \textbf{Cycles} & \textbf{Cycles} & \\
\midrule
$[1,4,4]$   & 1  & $3\times3$ & Scalar (baseline)   & 1,875      & 1,875    & 1.00$\times$ \\
$[1,8,8]$   & 2  & $3\times3$ & {\footnotesize IM2COL + GEMM (M8)} & 20,625     & 5,629    & 3.67$\times$ \\
$[1,32,32]$ & 6  & $5\times5$ & {\footnotesize IM2COL + GEMM (M8)} & 2,969,298  & 134,698  & 22.04$\times$ \\
$[1,32,32]$ & 32 & $5\times5$ & {\footnotesize IM2COL + GEMM (M8)} & 15,826,364 & 534,683  & \textbf{29.60$\times$} \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption{Additive Kernels — Best Implementation per Configuration}
\label{tab:add_full}
\vspace{1em}
\begin{tabular}{c c c c c c}
\toprule
\textbf{Kernel} & \textbf{Size / Shape} & \textbf{Best} & \textbf{Scalar} & \textbf{Best} & \textbf{Speedup} \\
& & \textbf{Implementation} & \textbf{Cycles} & \textbf{Cycles} & \\
\midrule
