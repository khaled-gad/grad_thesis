...
\textbf{Note:} The detailed results for each kernel are available in the project repository at \url{https://github.com/OmarAly03/RVV64_Library/tree/main/kernels}. Each kernel directory contains a \texttt{result.md} file with comprehensive test data.
...
% what is this paragraph trying to add? is this placement appropriate?
\paragraph{Comparison with ONNX Runtime}
