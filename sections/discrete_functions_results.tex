...
\midrule
Conv2D                   & $6.48 \times 10^{-5}$ & 123.9 -- 139.9 & \textcolor{blue}{ PASSED} \\
Conv2D Transposed       & $1.19 \times 10^{-7}$ & 143.2 -- 146.7 & \textcolor{blue}{ PASSED} \\
Conv2D $3\times3$ Specialized  & 0                     & $\infty$        & \textcolor{blue}{ PASSED} \\
Matrix Multiplication   & $2.86 \times 10^{-6}$ & 135.8 -- $\infty$ & \textcolor{blue}{ PASSED} \\
Dense Layer              & $4.29 \times 10^{-6}$ & 132.7 -- 132.9 & \textcolor{blue}{ PASSED} \\
ReLU                    & 0                     & $\infty$        & \textcolor{blue}{ PASSED} \\
Leaky ReLU              & 0                     & $\infty$        & \textcolor{blue}{ PASSED} \\
Max Pooling             & 0                     & $\infty$        & \textcolor{blue}{ PASSED} \\
Batch Normalization     & 0                     & $\infty$        & \textcolor{blue}{ PASSED} \\
Tensor Addition          & 0                     & $\infty$        & \textcolor{blue}{ PASSED} \\
Bias Addition            & 0                     & $\infty$        & \textcolor{blue}{ PASSED} \\
Gather Elements         & 0                     & $\infty$        & \textcolor{blue}{ PASSED} \\
Scatter Elements        & 0                     & $\infty$        & \textcolor{blue}{ PASSED} \\
NMS                      & 0                     & $\infty$        & \textcolor{blue}{ PASSED} \\
\midrule
...
\textbf{1. Perfect Accuracy Kernels}
...
\textbf{3. Transposed Convolution}
...
\textbf{4. Matrix Multiplication and Dense Layer}
...
\textbf{5. Numerical Accuracy Analysis}
