...
For this project, the Ara coprocessor is configured with a Vector Length ($VLEN$) of $1024$ bits, allowing a single vector register to hold $32$ single-precision floating-point numbers. The physical datapath is organized into \textbf{4 vector lanes}. 
